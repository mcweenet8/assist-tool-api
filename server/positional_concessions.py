...
def score_fixture(fixture_id, season_id, league_id, game_date=None):
    """Score all players in a fixture with positional concession multipliers."""
    ...
    # Pull concession multipliers for both teams in this fixture
    try:
    ...
    # Build team_id → opponent_team_id lookup
    ...
    for entry in lineups:
        ...
        # ── Apply positional concession multipliers ──
...
def get_season_scores():
    ...
    Minimum 270 minutes. Market-specific scaling to match FotMob distribution.
    """
    try:
